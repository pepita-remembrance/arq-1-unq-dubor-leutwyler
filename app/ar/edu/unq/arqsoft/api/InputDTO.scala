...
case class LoginDTO(email: String, password: String) extends InputDTO

case class CreateStudentDTO(fileNumber: Int, email: String, name: String, surname: String, password: String) extends InputDTO

case class CreateAdminDTO(fileNumber: Int, email: String, name: String, surname: String, password: String) extends InputDTO
